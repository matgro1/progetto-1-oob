...
public class ChecklistItemDAOImpl implements ChecklistItemDAO {
    ...
    private static final Logger LOGGER = Logger.getLogger(ChecklistItemDAOImpl.class.getName());
    ...
    public ChecklistItem save(ChecklistItem item) {
        ...
        try (Connection conn = DatabaseConnection.getConnection(); PreparedStatement stmt = conn.prepareStatement(sql)) {
            ...
            LOGGER.log(Level.SEVERE, "errore inserimento checklist item", e);
            return null;
        }
    }
    ...
    public List<ChecklistItem> findByToDoId(int todoId) {
        String sql = "SELECT id, descrizione, stato, todo_id FROM checklist_items WHERE todo_id = ?";
        try (Connection conn = DatabaseConnection.getConnection(); PreparedStatement stmt = conn.prepareStatement(sql)) {
            ...
            LOGGER.log(Level.SEVERE, "errore ricerca checklist items per todo id", e);
    ...
    public void delete(int id) {
        ...
        try (Connection conn = DatabaseConnection.getConnection(); PreparedStatement stmt = conn.prepareStatement(sql)) {
            ...
            LOGGER.log(Level.SEVERE, "errore eliminazione checklist item", e);
        }
    }
    ...
    public void update(ChecklistItem item) {
        ...
        try (Connection conn = DatabaseConnection.getConnection(); PreparedStatement stmt = conn.prepareStatement(sql)) {
            ...
            LOGGER.log(Level.SEVERE, "errore aggiornamento checklist item", e);
        }
    }
}